//
//  InstagramSubmit.swift
//  The Mask
//
//  Created by Jan Janovec on 17.12.2021.
//
...
struct InstagramSharingUtils {
  ...
  private static var instagramStoriesUrl: URL? {
    if let url = URL(string: "instagram-stories://share?source_application=com.MENDELU-JanJanovec.The-Mask") {
